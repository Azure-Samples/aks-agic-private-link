...
// Resources
resource applicationGateway 'Microsoft.Network/applicationGateways@2022-07-01' existing = if (applicationGatewayEnabled) {
  name: applicationGatewayName
}

resource applicationGatewayIdentity 'Microsoft.ManagedIdentity/userAssignedIdentities@2018-11-30' existing = if (applicationGatewayEnabled) {
...
resource applicationGatewayAgicManagedIdentityOperatorRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (applicationGatewayEnabled) {
  ...
  name: guid(aksCluster.id, applicationGatewayIdentity.name, 'managedIdentityOperator')
  properties: {
...
resource applicationGatewayAgicContributorRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (applicationGatewayEnabled) {
  ...
  name: guid(resourceGroup().id, applicationGatewayName, 'contributor')
  properties: {
...
resource applicationGatewayAgicReaderRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (applicationGatewayEnabled) {
  scope: resourceGroup()
  name: guid(resourceGroup().id, applicationGatewayName, 'reader')
  properties: {
